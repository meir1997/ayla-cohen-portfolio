...
export default function Home() {
  return (
    <div className="h-screen w-screen overflow-hidden bg-neutral-900 flex flex-col items-center justify-center relative">

      {/* Softened background video */}
      <video
        className="hero-background-video absolute inset-0 h-full w-full object-cover object-[28%_center] md:object-center"
        autoPlay
        loop
        muted
        playsInline
      ...
      <div className="absolute top-6 left-6 md:top-8 md:left-8 flex gap-3 z-10">
        <a
          ...
          aria-label="WhatsApp"
          className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/90 text-dark flex items-center justify-center hover:bg-white transition-colors"
        >
        ...
        <a
          href="https://www.instagram.com/ayalacohen.design/"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://www.facebook.com/profile.php?id=100089356337105"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Facebook"
          className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/90 text-dark flex items-center justify-center hover:bg-white transition-colors"
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4">
        ...
        <div className="mb-8 md:mb-10">
          <img
            ...
            alt="אילה כהן"
            className="h-32 md:h-44 w-auto object-contain brightness-0 invert"
          />
        </div>
        ...
        <Link
          href="/guide"
          className="mt-12 md:mt-16 inline-flex items-center gap-3 px-6 py-3 border border-white/80 bg-black/15 backdrop-blur-sm text-white text-sm tracking-[0.15em] hover:bg-white hover:text-dark transition-colors duration-300 group"
        >
          <span className="bg-white text-dark text-[10px] px-2 py-0.5 tracking-widest group-hover:bg-dark group-hover:text-white transition-colors">
            מתנה
          </span>
          המדריך לעיצוב הבית
      ...
      <div className="absolute z-10 bottom-1 md:bottom-4 left-0 right-0 flex flex-col md:flex-row items-center justify-center gap-0 md:gap-5 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="min-h-11 inline-flex items-center text-xs text-gray-200 underline underline-offset-4 hover:text-white transition-colors"
        >
